...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({Exception.class,ApiException.class, BadCredentialsException.class, DataNotFoundException.class,AccessDeniedException.class, AuthenticationException.class})
    public CoreApiResponse<?> handleCoreException(Exception error) {
        if(error instanceof ApiException){
            ApiException appException =(ApiException) error;
