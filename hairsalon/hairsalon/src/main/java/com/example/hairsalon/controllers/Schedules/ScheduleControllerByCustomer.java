...
public class ScheduleControllerByCustomer {
    @Autowired
    ...
    public ResponseEntity<String> updateSchedules(@PathVariable Integer scheduleID,
            @RequestBody SchedulePutRequest request) {
